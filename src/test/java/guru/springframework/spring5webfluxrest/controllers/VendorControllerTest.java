...
public class VendorControllerTest {
    ...
    public void testCreateVendor() {
        BDDMockito.given(vendorRepository.saveAll(any(Publisher.class)))
                .willReturn(Flux.just(Vendor.builder().firstName("Jimmy").lastName("Johns").build()));

        Mono<Vendor> vendorToSaveMono = Mono.just(Vendor.builder().firstName("Jimmy").lastName("Johns").build());
